...
async def predict(
    ...
    # استخراج التنبؤ
    predicated_grade= predictions['prediction_label'].iloc[0]
    grade_map = {
        0: 'ممتاز (90-100%)',
        1: 'جيد جدًا (80-89%)',
        2: 'جيد (70-79%)',
    ...
    grade=grade_map.get(predicated_grade,"غير معروف")
